...
{
    public class PartAssemblyController_Beauty : MonoBehaviour
    {
        ...
        public void Set()
        {
            ...
            DestroyMonument_Beauty.instance.PieceAttached();
        }
        ...
        private IEnumerator CheckPlacement()
        {
            while (true)
            {
                MaxDistance = (MonumentScale.currentScale.x * 0.8098477486232588f);
